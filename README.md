...
[sparkfun-pro-micro-rp2040]: https://github.com/rp-rs/sparkfun-pro-micro-rp2040
...
```console
sparkfun-pro-micro-rp2040 $ cargo build --release --example <name>
```
...
```console
sparkfun-pro-micro-rp2040 $ cargo run --release --example <name>
```
...
6. Create a [New Pull Request](https://github.com/rp-rs/sparkfun-pro-micro-rp2040/pulls)
